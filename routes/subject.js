...
router.get(
	"/:classId",
	[requireRole(["Admin", "Staff"]), validateObjectIds("classId")],
	subjectController.fetchAllByClass
)
router.get(
	"/:classId/:subjectId",
	[requireRole(["Admin", "Staff"]), validateObjectIds(["classId", "subjectId"])],
	subjectController.fetchById
)
router.put(
	"/:subjectId",
