...
import { uploadSingleImage, uploadBatchUsersCsv } from "../middleware/uploadFiles.js"


router.post("/student", [requireRole(['Admin', 'Staff']), uploadSingleImage('profileImage')], userController.createUser)
router.post("/batch-upload", [requireRole(['Admin', 'Staff']), uploadBatchUsersCsv('csvFile')], userController.batchCreateUser)
...
router.put("/:userId", [requireRole('Admin'), validateObjectIds('userId'), uploadBatchUsersCsv('profileImage')], userController.updateUser)
