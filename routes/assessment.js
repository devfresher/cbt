...
router.post(
	"/",
	[requireRole(["Admin", "Staff"]), isSubjectTeacher],
...
router.get(
	"/:subjectId",
	[requireRole(["Admin", "Staff"]), validateObjectIds("subjectId")],
	assessmentController.fetchAllBySubject
)
router.get(
	"/:subjectId/:assessmentId",
	[requireRole(["Admin", "Staff"]), validateObjectIds(["subjectId", "assessmentId"])],
	assessmentController.fetchById
)

router.patch(
	"/:assessmentId/release-result",
	[requireRole(["Admin"]), validateObjectIds("assessmentId")],
	assessmentController.updateAssessment
)
router.put(
	"/:assessmentId",
	[requireRole(["Admin", "Staff"]), validateObjectIds("assessmentId"), isSubjectTeacher],
	assessmentController.updateAssessment
)
router.delete(
	"/:assessmentId",
